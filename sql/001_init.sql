...
CREATE TABLE menus (
    ...
    org_id BIGINT UNSIGNED NOT NULL,
    name VARCHAR(255) NOT NULL,
    menu_type ENUM('package','per_item') NOT NULL DEFAULT 'package',
    price_min_minor INT NULL,
    price_max_minor INT NULL,
    currency CHAR(3) NOT NULL DEFAULT 'USD',
    price_label_suffix VARCHAR(10) NULL,
    min_pax INT NULL,
    default_waste_pct DECIMAL(5,4) NOT NULL DEFAULT 0.0000,
...
CREATE TABLE menu_groups (
    ...
    name VARCHAR(255) NOT NULL,
    uptake_pct DECIMAL(5,4) NULL,
    portion DECIMAL(10,4) NULL,
    waste_pct DECIMAL(5,4) NULL,
    sort_order INT NOT NULL DEFAULT 0,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NULL DEFAULT NULL,
