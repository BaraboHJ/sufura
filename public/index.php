...
use App\Controllers\AdminUomController;
...
$adminUomController = new AdminUomController($pdo);
...
$router->get('/admin/uoms', [$adminUomController, 'index']);
$router->post('/admin/uoms/:id/update', [$adminUomController, 'update']);
